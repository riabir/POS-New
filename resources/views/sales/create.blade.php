                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="phone_search" class="form-control" placeholder="Enter 10-digit number" maxlength="10">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                            ...
                            <div id="commission_content" class="p-4 border-t border-gray-200 dark:border-gray-700 hidden">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">+880</span>
                                            <input type="text" id="commission_phone_search" class="form-control" placeholder="Enter 10-digit number" maxlength="10">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
