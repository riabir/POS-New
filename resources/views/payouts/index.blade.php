<x-app-layout>
    ...
    <style>
        .styled-table { width: 100%; border-collapse: collapse; } .styled-table thead tr { background-color: #f8f9fa; color: #333; text-align: left; } .styled-table th, .styled-table td { padding: 12px 15px; border-bottom: 1px solid #ddd; } .dark .styled-table thead tr { background-color: #374151; color: #f3f4f6; } .dark .styled-table th, .dark .styled-table td { border-color: #4b5563; } .dark .styled-table tbody tr { background-color: #374151; } .dark .styled-table td { color: #f3f4f6; } .actions-container { display: flex; gap: 1rem; align-items: center; } .clickable-row { cursor: pointer; transition: background-color 0.2s ease-in-out; } .clickable-row:hover { background-color: #f1f5f9; } .dark .clickable-row:hover { background-color: #4a5568; }
    </style>
