                        ...
                        <form method="post" action="{{route('brands.update', $brands->id)}}">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="category_id" name="category_id"
                                    value="{{$brands->catagory_id}}">
                                    <option value="{{$brands->category_id}}">{{$brands->category->name}}</option>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="product_type_id" name="product_type_id">
                                    <option value="{{$brands->product_type_id}}">{{$brands->productType->name}}
                                    </option>
                                </select>
                            </div>
